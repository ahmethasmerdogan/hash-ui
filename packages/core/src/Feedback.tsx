...
import { ICheckCircleFill, IInfo, IWarning, IX } from "./icons.js";
...
export function Tooltip({
  ...
  return (
    <span className={cx("group/tip relative inline-flex", className)}>
      ...
      <span
        role="tooltip"
        className="pointer-events-none absolute bottom-full left-1/2 z-30 mb-2 -translate-x-1/2 scale-95 rounded-lg bg-[#1c1b18] px-2.5 py-1.5 text-[12px] font-medium whitespace-nowrap text-white opacity-0 shadow-pop transition-all delay-75 duration-150 group-hover/tip:scale-100 group-hover/tip:opacity-100 group-focus-within/tip:scale-100 group-focus-within/tip:opacity-100 dark:bg-white dark:text-[#1c1b18]"
      >
        {label}
        <span className="absolute top-full left-1/2 -mt-1 size-2 -translate-x-1/2 rotate-45 bg-[#1c1b18] dark:bg-white" />
      </span>
    </span>
  );
}
