...
export const SITE = {
  ...
  description:
    "A flat, shadow-free React 19 + Tailwind CSS v4 design system — 96 components, 25 page blocks and 83 hand-drawn icons, in light and dark, with five accent themes.",
